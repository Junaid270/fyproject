...
router.post('/register', async (req, res) => {
  try {
    ...
    const { username, phone, adhaar, email, password, role } = req.body;

    // Input validation checks
    if (!username || !phone || !adhaar || !email || !password || !role) {
    ...
    // Create new user
    const newUser = new User({ username, phone, adhaar, email, password: hashedPassword, role });
